...
class NFSDataset(BaseDataset):
    ...
    def _get_sequence_info_list(self):
        sequence_info_list = [
            ...
            {"name": "nfs_dogs", "path": "sequences/dogs", "startFrame": 1, "endFrame": 197, "nz": 5, "ext": "jpg", "anno_path": "anno/nfs_dogs.txt", "object_class": "dog", 'occlusion': True},
        ...
        for seq in sequence_info_list:
            seq_name = seq['path'].split('/')[1]
            seq['path'] = seq_name+'/'+seq_name+'/'+'30'+'/'+ seq_name
            seq['anno_path'] = seq_name+'/'+seq_name+'/'+'30'+'/'+ seq_name +'_n1_biaozhun.txt'
