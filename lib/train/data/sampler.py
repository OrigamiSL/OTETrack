...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets,samples_per_epoch, max_gap,
        ...
        # if p_datasets_seq is None:
        #     p_datasets_seq = [len(d) for d in self.datasets_seq]
        # # Normalize
        # p_total_seq = sum(p_datasets_seq)
        # self.p_datasets_seq = [x / p_total_seq for x in p_datasets_seq]
        ...
        # self.processing_seq = processing_seq
        self.frame_sample_mode = frame_sample_mode 
        # self.frame_sample_mode = 'sample_seq'
        # casual
        
        self.max_interval = 5 #cfg.DATA.MAX_INTERVAL = 5
        # self.prob=prob
        self.extra=1
    ...
    def _sample_visible_ids(self, visible, num_ids=1, min_id=None, max_id=None,
        ...
        return random.choices(valid_ids, k=num_ids) #在所选序列中随即取K个
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            # print('Select')
            data = []
            dataset = random.choices(self.datasets, self.p_datasets)[0] #随机取一个数据集
